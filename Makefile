...
SRC_CORE              := $(abspath $(SRC_CORE_DIR))

FREERTOS_DIR_REL      := ./FreeRTOSv202112.00/FreeRTOS
FREERTOS_DIR          := $(abspath $(FREERTOS_DIR_REL))

FREERTOS_PLUS_DIR_REL := ./FreeRTOSv202112.00/FreeRTOS-Plus
...
#
INCLUDE_DIRS          += -I${SRC_CORE}

SOURCE_FILES          := $(wildcard *.c)
SOURCE_FILES          += $(wildcard ${FREERTOS_DIR}/Source/*.c)
#
SOURCE_FILES          += $(wildcard ${SRC_CORE}/*.c)
